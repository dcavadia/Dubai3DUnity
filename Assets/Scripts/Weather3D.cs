...
public class Weather3D : MonoBehaviour
{
    ...
    {
        Weather weatherInfoTask = await WeatherAPI.GetWeather();
        SetWeatherStatus(weatherInfoTask);
    }

    public void SetWeatherStatus(Weather weatherObj)
    {
    ...
    public void SpawnWeatherPrefabAPI(eWeatherState actualWeather, string location, string weatherCondition, string temperature)
    {
        ...
        {
            Weather3D.WEATHER_STATE = actualWeather;
            locationUI.text = location;
            conditionUI.text = weatherCondition;
            S.weatherState = Weather3D.WEATHER_STATE;
    ...
    private void WeatherStateChanged()
    {
        ...
        if (Weather3D.WEATHER_STATE != S.weatherState)
        {
            ...
            Weather3D.WEATHER_STATE = S.weatherState;
        }
    }
    ...
    {
        switch (Weather3D.WEATHER_STATE)
        {
            case eWeatherState.none:
